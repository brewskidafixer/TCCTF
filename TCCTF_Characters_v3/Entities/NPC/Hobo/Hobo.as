...
void onInit(CBlob@ this)
{
	...
	if (rand.NextRanged(100) < 25)
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 12000 + XORRandom(4500));
		s.spawnNothing = true;
	}
	...
	if (rand.NextRanged(100) < 10)
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 25000 + XORRandom(7000));
		s.spawnNothing = true;
	}
	...
	if (rand.NextRanged(100) < 30)
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 2000 + rand.NextRanged(2000));
		s.spawnNothing = true;
	}
	...
	if (rand.NextRanged(100) < 30)
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 2000 + rand.NextRanged(500));
		s.spawnNothing = true;
	}
	...
	if (rand.NextRanged(100) < 20)
	{
		...
		AddRequirement(s.requirements, "coin", "", "Coins", 5000 + rand.NextRanged(1000));
		s.spawnNothing = true;
	}
	...
	if (rand.NextRanged(100) < 20)
	{
...

		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", 350 + rand.NextRanged(300));
			s.spawnNothing = true;
		}
	}
	...
	if (rand.NextRanged(100) < 50)
	{
		if (rand.NextRanged(100) < 10)
		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", 2500 + rand.NextRanged(1000));
			s.spawnNothing = true;
		}
		...
		if (rand.NextRanged(100) < 30)
		{
			ShopItem@ s = addShopItem(this, "purple shit", "$mat_matter$", "mat_matter-10", "rare shit");
			AddRequirement(s.requirements, "coin", "", "Coins", 20000 + rand.NextRanged(6000));
			s.spawnNothing = true;
		}
	}
	else if (rand.NextRanged(100) < 40)
	{
		...
		if (rand.NextRanged(100) < 50)
		{
			u32 cost = getRandomCost(@rand, 1250, 1600);
		...
		if (rand.NextRanged(100) < 50)
		{
			u32 cost = getRandomCost(@rand, 2000, 2500);
...
void onDie(CBlob@ this)
{
	if (isServer())
	{
		server_DropCoins(this.getPosition(), 250 + XORRandom(250));
	}
}
