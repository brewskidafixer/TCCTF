...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks, int teamnum = 7)
{
	...
	AddIconToken("$icon_drugshop$", "DrugShop.png", Vec2f(40, 24), 0, teamnum);
	...
	AddIconToken("$icon_extractor$", "Extractor.png", Vec2f(16, 16), 0);
	...
	AddIconToken("$icon_stonepile$", "StonePile.png", Vec2f(24, 24), 3, teamnum);
	...
	AddIconToken("$icon_powerdrillrig$", "PowerDrillRig.png", Vec2f(24, 24), 0, teamnum);
	...
	AddIconToken("$icon_banditshack$", "BanditShack.png", Vec2f(40, 32), 0, teamnum);
	...
	{
		BuildBlock b(CMap::tile_plasteel, "plasteel_block", "$plasteel_block$", "Plasteel Panel\nAn advanced composite material. Nearly indestructible. Immune to Bullets");
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel Sheet", 5);
		blocks[0].push_back(b);
	}
	{
	...
	}
	{
		...
		AddRequirement(b.reqs, "blob", "mat_plasteel", "Plasteel Sheet", 10);
		blocks[0].push_back(b);
	}
	{
	...
	*/
	...
	{
		BuildBlock b(0, "drugshop", "$icon_drugshop$", "Chemist's Workstation\nCraft various drugs, as well materials.");
		AddRequirement(b.reqs, "blob", "mat_wood", "Wood", 250);
	...
	{
		BuildBlock b(0, "powerdrillrig", "$icon_powerdrillrig$", "Power Driller Mole\nAn automatic power drilling machine that mines resources underneath.");
		AddRequirement(b.reqs, "blob", "powerdrill", "Power Drill", 1);
