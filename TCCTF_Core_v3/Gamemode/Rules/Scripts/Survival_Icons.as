...
void ReloadIcons(CRules@ this)
{
	...
	AddIconToken("$icon_nightgoggles$", "NightGoggles.png", Vec2f(16, 16), 0);
	AddIconToken("$icon_lighthelmet$", "LightHelmet.png", Vec2f(16, 16), 0);
	AddIconToken("$icon_lightvest$", "LightVest.png", Vec2f(16, 16), 0);
	AddIconToken("$icon_mediumhelmet$", "MediumHelmet.png", Vec2f(16, 16), 0);
	AddIconToken("$icon_mediumvest$", "MediumVest.png", Vec2f(16, 16), 0);
	AddIconToken("$icon_heavyhelmet$", "HeavyHelmet.png", Vec2f(16, 16), 0);
	AddIconToken("$icon_heavyvest$", "HeavyVest.png", Vec2f(16, 16), 0);
