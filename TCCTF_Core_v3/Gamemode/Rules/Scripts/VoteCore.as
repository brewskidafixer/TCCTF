...
void onRender(CRules@ this)
{
	...
	if (can_force_pass)
	{
		GUI::DrawText(getTranslatedString("Ctrl+O Pass"), tl + Vec2f(3, 18 + text_dim.y * 5), SColor(0xff30bf30));
	}

	if (can_cancel)
	{
		GUI::DrawText(getTranslatedString("Ctrl+P Cancel"), tl + Vec2f(95, 18 + text_dim.y * 5), SColor(0xffbf3030));
	}
