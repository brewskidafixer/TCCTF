...
void fromTile(CBlob@ this, uint16 &in type, float &in damage)
{
	...
	{
		createFor(this, 'mat_stone', 15 * damage);
		if (XORRandom(10) < 6) createFor(this, 'mat_iron', 12 * damage);
		if (XORRandom(10) < 3) createFor(this, 'mat_copper', 3 * damage);
		if (XORRandom(10) == 0) createFor(this, 'mat_coal', 10 * damage);
	}
	else if (map.isTileStone(type))
	{
		createFor(this, 'mat_stone', 6 * damage);
		if (XORRandom(10) < 6) createFor(this, 'mat_iron', 3 * damage);
		if (XORRandom(10) < 3) createFor(this, 'mat_copper', damage);
		if (XORRandom(10) == 0) createFor(this, 'mat_coal', 2 * damage);
	}
	...
	{
		createFor(this, 'mat_dirt', 5 * damage);
		if (XORRandom(10) < 6) createFor(this, 'mat_sulphur', 2 * damage);
		if (XORRandom(10) < 6) createFor(this, 'mat_copper', damage);
	}
  }
}
