...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Deconstruct 10 Plasteel Sheets", "$icon_matter_0$", "mat_matter-15", "Deconstruct 10 Plasteel Sheets into 15 units of Amazing Technicolor Dust.");
	...
	{
		ShopItem@ s = addShopItem(this, "Deconstruct a Charge Rifle", "$icon_matter_1$", "mat_matter-100", "Deconstruct 1 Charge Rifle into 100 units of Amazing Technicolor Dust.");
	...
	{
		ShopItem@ s = addShopItem(this, "Deconstruct a Charge Blaster", "$icon_matter_2$", "mat_matter-150", "Deconstruct 1 Charge Blaster into 150 units of Amazing Technicolor Dust.");
		AddRequirement(s.requirements, "blob", "chargeblaster", "Charge Blaster", 1);
		// AddRequirement(s.requirements, "blob", "mat_mithrilingot", "Mithril Ingot", 20);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Deconstruct an Exosuit", "$icon_matter_3$", "mat_matter-200", "Deconstruct 1 Exosuit into 200 units of Amazing Technicolor Dust.");
	...
	{
		ShopItem@ s = addShopItem(this, "Transmute Mithril to Technicolor Dust", "$icon_matter_2$", "mat_matter-250", "Transmute 250 Mithril into 250 Technicolor Dust.");
	...
	{
		ShopItem@ s = addShopItem(this, "Refine Mithril", "$mat_mithrilingot$", "mat_mithrilingot-10", "Refine 50 Mithril Ore into 10 Mithril Ingots.");
	...
	{
		ShopItem@ s = addShopItem(this, "Reconstruct 50 Plasteel Sheets", "$icon_plasteel$", "mat_plasteel-50", "A durable yet lightweight material.");
		AddRequirement(s.requirements, "blob", "mat_concrete", "Concrete", 200);
		AddRequirement(s.requirements, "blob", "mat_matter", "Amazing Technicolor Dust", 25);
	...
	{
		ShopItem@ s = addShopItem(this, "Construct a Mithril Warhead", "$mat_mithrilbomb$", "mat_mithrilbomb-1", "Mithril Bomb.");
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("shop made item"))
	{
		...
		if (isServer())
		{
			...
			{
				CBlob@ crate = server_MakeCrate("drone", "Scyther Construction Kit", 0, callerBlob.getTeamNum(), this.getPosition(), false);
				crate.Tag("plasteel");
				crate.Init();
