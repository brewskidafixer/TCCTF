...
const GramophoneRecord@[] records =
{
	...
	GramophoneRecord("My Last War", "Disc_AoT_MyLastWar.ogg"),
	GramophoneRecord("National Anthem of USSR", "Disc_National_Anthem_of_USSR.ogg"),
	GramophoneRecord("TC Anthem", "Disc_Der_Koniggratzer_Marsch.ogg"),
	GramophoneRecord("Katyusha Катюша", "Disc_Katyusha.ogg"),
	GramophoneRecord("Steins Gate - The Last Game", "Disc_SteinsGate_TheLastGame.ogg"),
	GramophoneRecord("Moonsong", "Disc_Moonsong.ogg"),
	GramophoneRecord("Preparing for War", "Disc_Preparing_for_War.ogg")
};