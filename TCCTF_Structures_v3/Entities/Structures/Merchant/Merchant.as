...
void onInit(CBlob@ this)
{
	...
	this.set_f32("capture_speed_modifier", 0.50f);
	...
	{
		ShopItem@ s = addShopItem(this, "Buy Stone (250)", "$mat_stone_1x$", "mat_stone-250", "Buy 250 stone for 2500 coins.");
		AddRequirement(s.requirements, "coin", "", "Coins", 250);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Buy Stone (2500)", "$mat_stone_10x$", "mat_stone-2500", "Buy 2500 stone for 2500 coins.");
		AddRequirement(s.requirements, "coin", "", "Coins", 2500);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Buy Wood (250)", "$mat_wood_1x$", "mat_wood-250", "Buy 250 wood for 125 coins.");
		AddRequirement(s.requirements, "coin", "", "Coins", 125);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Buy Wood (2500)", "$mat_wood_10x$", "mat_wood-2500", "Buy 2500 wood for 1250 coins.");
	...
	{
		u32 cost = getRandomCost(@rand, 60, 90);
		{
	...
	{
		u32 cost = getRandomCost(@rand, 75, 125);
		{
			ShopItem@ s = addShopItem(this, "Sell Vodka (1)", "$vodka$", "coin-" + cost, "Sell 1 vodka for " + cost + " coins.");
			AddRequirement(s.requirements, "blob", "vodka", "Vodka", 1);
			s.spawnNothing = true;
		}
		{
			ShopItem@ s = addShopItem(this, "Sell Vodka (20)", "$vodka$", "coin-" + cost*20, "Sell 20 vodka for " + cost*20 + " coins.");
			AddRequirement(s.requirements, "blob", "vodka", "Vodka", 20);
			s.spawnNothing = true;
		}
	}
	{
		...
		{
			ShopItem@ s = addShopItem(this, "Sell Scrub's Chow (10)", "$foodcan$", "coin-" + cost*10, "Sell 10 Scrub's Chow for " + cost*10 + " coins.");
			AddRequirement(s.requirements, "blob", "foodcan", "Scrub's Chow", 10);
			s.spawnNothing = true;
		}
	}
	{
	...
	{
		u32 cost = getRandomCost(@rand, 400, 500);
		ShopItem@ s = addShopItem(this, "Sell Methane Gas (100)", "$mat_methane$", "coin-" + cost, "Sell 100 Bottles of Methane for " + cost + " coins.");
		AddRequirement(s.requirements, "blob", "mat_methane", "Methane (50)", 100);
		s.spawnNothing = true;
	}
	{
		u32 cost = getRandomCost(@rand, 900, 1000);
		ShopItem@ s = addShopItem(this, "Sell Fuel Gas (50 l)", "$mat_fuel$", "coin-" + cost, "Sell 50 Bottles of Fuel for " + cost + " coins.");
		AddRequirement(s.requirements, "blob", "mat_fuel", "Fuel (50)", 50);
		s.spawnNothing = true;
	}
	{
		u32 cost = getRandomCost(@rand, 300, 400);
		ShopItem@ s = addShopItem(this, "Sell Acid Gas (50 l)", "$mat_acid$", "coin-" + cost, "Sell 50 Drums of Acid for " + cost + " coins.");
		AddRequirement(s.requirements, "blob", "mat_acid", "Acid (50)", 50);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Kitten", "$icon_kitten$", "kitten", "A cute little kitten! Take care of it!", false, true);
		AddRequirement(s.requirements, "coin", "", "Coins", getRandomCost(@rand, 600, 800));
		s.spawnNothing = true;
	}
	{
	...
	{
		ShopItem@ s = addShopItem(this, "Sell Concrete (2500)", "$COIN$", "coin-1500", "Sell 2500 Concrete for 1500 coins.");
		AddRequirement(s.requirements, "blob", "mat_concrete", "Concrete", 2500);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Sell Iron Ingot (500)", "$COIN$", "coin-2500", "Sell 500 Iron Ingots for 2500 coins.");
		AddRequirement(s.requirements, "blob", "mat_ironingot", "Iron Ingot", 500);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Sell Copper Ingot (500)", "$COIN$", "coin-2000", "Sell 500 Copper Ingots for 2000 coins.");
		AddRequirement(s.requirements, "blob", "mat_copperingot", "Copper Ingot", 500);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Sell Steel Ingot (500)", "$COIN$", "coin-3250", "Sell 500 Steel Ingots for 3250 coins.");
		AddRequirement(s.requirements, "blob", "mat_steelingot", "Steel Ingot", 500);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Sell Coal (500)", "$COIN$", "coin-1000", "Sell 500 Coal for 1000 coins.");
		AddRequirement(s.requirements, "blob", "mat_coal", "Coal", 500);
		s.spawnNothing = true;
	}
	{
		ShopItem@ s = addShopItem(this, "Sell Gold Ingot (100)", "$COIN$", "coin-10000", "Sell 100 Gold Ingots for 10000 coins.");
	...
	if(cmd == this.getCommandID("shop made item"))
	{
		...
		if (isServer())
		{
			...
			if (spl[0] == "coin")
			{
				...
				u16 totalCoins = callerPlayer.getCoins() +  parseInt(spl[1]);
				if (totalCoins >  30000)
				{
