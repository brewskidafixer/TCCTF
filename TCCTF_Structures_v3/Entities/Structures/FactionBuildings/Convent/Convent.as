...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Juggernaut Hammer", "$juggernauthammer$", "juggernauthammer", "Construct a Juggernaut Hammer.");
		AddRequirement(s.requirements, "coin", "", "", 7500);
		AddRequirement(s.requirements, "blob", "mat_steelingot", "Steel Ingot", 20);
		AddRequirement(s.requirements, "blob", "mat_ironingot", "Steel Ingot", 15);
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	...
	if (cmd == this.getCommandID("shop made item"))
	{
		...
		else if (isServer()) server_CreateBlob("juggernauthammer", this.getTeamNum(), this.getPosition());
	}
}
