...
void onInit(CBlob@ this)
{
	...
	this.set_Vec2f("shop menu size", Vec2f(12, 14));
	...
	{
		ShopItem@ s = addShopItem(this, "Luxury Car", "$icon_luxurycar$", "car", "$icon_luxurycar$\n\n\n\n" + "Drive it like a race car.", false, true);
		AddRequirement(s.requirements, "blob", "mat_ironingot", "Iron Ingot", 10);
		AddRequirement(s.requirements, "blob", "mat_copperwire", "Copper Wire", 10);
	...
	{
		ShopItem@ s = addShopItem(this, "Big Tank", "$icon_chickentank$", "chickentank", "$icon_chickentank$\n\n\n\n\n" + "A big tank used to run people over and exploding buildings for fun.\n\nUses Howitzer Shells as Ammunition", false, true);
...
void addTokens(CBlob@ this)
{
	...
	AddIconToken("$icon_luxurycar$", "Car.png", Vec2f(40, 24), 0, teamnum);
	...
	AddIconToken("$icon_uav$", "UAV.png", Vec2f(50, 18), 0, teamnum);
	AddIconToken("$icon_chickentank$", "ChickenTank_Icon.png", Vec2f(96, 40), 0, teamnum);
}
