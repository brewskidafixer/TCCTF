		...
		if (caller !is null)
		{
			...
			if (carried !is null && carried.getName() == "mat_copperingot")
			{
				...
				if (carried.getQuantity() >= cost)
				{
					...
					else carried.server_Die();

					this.add_f32("upgrade", 2000.00f);
					this.add_s16("upgrade_cost", 2);
				}
		...
		if (inv !is null)
		{
			...
			if (pressure > 25000 && heat > 1000 && hasRippio && hasFiks && hasDangerMeat && dangermeat_count >= 45)
			{
				if (isServer())
				{
					...
					Material::createFor(this, "gooby", 3 + XORRandom(4));
				}

				if (isClient()) this.getSprite().PlaySound("DrugLab_Create_Solid.ogg", 1.00f, 1.00f);
			}
			...
			if (heat < 300 && hasDangerMeat && dangermeat_count >= 15)
			{
				...
				if (isClient()) this.getSprite().PlaySound("DrugLab_Create_Gas.ogg", 1.00f, 1.00f);
			}
			...
			if (heat > 1500 && hasPumpkin)
			{
				...
				if (isClient()) this.getSprite().PlaySound("DrugLab_Create_Acidic.ogg", 1.00f, 1.00f);
			}
			...
			if (pressure > 70000 && heat > 1300 && hasCoal)
			{
				...
				if (isClient()) this.getSprite().PlaySound("DrugLab_Create_Viscous.ogg", 1.00f, 1.00f);
			}
			...
			if (pressure > 1000 && heat > 300 && meat_blob !is null)
			{
				...
				if (isClient()) this.getSprite().PlaySound("DrugLab_Create_Fart.ogg", 1.00f, 1.00f);
			}
			...
			if (pressure > 25000 && heat > 400 && hasSulphur && hasAcid && sulphur_count >= 50 && acid_count >= 50)
			{
				...
				if (isClient()) this.getSprite().PlaySound("DrugLab_Create_Liquid.ogg", 1.00f, 1.00f);
			}
			...
			if (heat > 500 && dirt_blob !is null && meat_blob !is null && hasAcid && dirt_count >= 50 && meat_count > 15 && acid_count >= 25)
			{
				...
				if (isClient()) this.getSprite().PlaySound("DrugLab_Create_Creamy.ogg", 1.00f, 1.00f);
			}
			...
			if (pressure < 50000 && heat > 100 && hasDirt && hasAcid)
			{
				...
				if (isServer())
				{
					...
					Material::createFor(this, "mat_sulphur", count * 4.00f);
				}
			...
			if (pressure < 25000 && heat > 500 && heat < 2000 && hasAcid && hasMithril && acid_count >= 15 && mithril_count >= 5)
			{
				if (isServer())
				{
					...
					Material::createFor(this, "fiks", 6 + XORRandom(4));
					Material::createFor(this, "domino", 5 + XORRandom(5));
				}
