...
void onInit(CBlob@ this)
{
	...
	if (this.getName() == "altar")
	{
		...
		
		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", 100+XORRandom(5000));
			s.customButton = true;
			s.buttonwidth = 2;	
			s.buttonheight = 2;
		...
		}
		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", 100+XORRandom(2500));
			s.customButton = true;
			s.buttonwidth = 2;	
			s.buttonheight = 2;
		...
		}
		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", 100+XORRandom(3000));
			s.customButton = true;
			s.buttonwidth = 2;	
			s.buttonheight = 2;
		...
		}
		{
			...
			AddRequirement(s.requirements, "blob", "mat_mithril", "Mithril", 100+XORRandom(600));
		...
		}
		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", 2000+XORRandom(10000));
			s.customButton = true;
			s.buttonwidth = 2;	
			s.buttonheight = 2;
		...
		}
		{
			...
			AddRequirement(s.requirements, "coin", "", "Coins", 4000+XORRandom(10000));
			s.customButton = true;
			s.buttonwidth = 2;	
			s.buttonheight = 2;
			s.spawnNothing = true;
