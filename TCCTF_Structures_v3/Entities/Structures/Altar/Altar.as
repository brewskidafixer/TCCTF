...
u16 getRandomCost(Random@ random, u16 number)
{
	return random.NextRanged(number);
}
...
void onInit(CBlob@ this)
{
	...
	if (this.getName() == "altar")
	{
		...
		{
			u16 randomCost = 100+getRandomCost(@rand, 5000);
			...
			AddRequirement(s.requirements, "coin", "", "Coins", randomCost);
			s.customButton = true;
			s.buttonwidth = 2;	
			s.buttonheight = 2;
		...
		{
			u16 randomCost = 100+getRandomCost(@rand, 2500);
		...
		{
			u16 randomCost = 100+getRandomCost(@rand, 3000);
		...
		{
			u16 randomCost = 100+getRandomCost(@rand, 600);
			...
			AddRequirement(s.requirements, "blob", "mat_mithril", "Mithril", randomCost);
		...
		{
			u16 randomCost = 2000+getRandomCost(@rand, 10000);
		...
		{
			u16 randomCost = 1000+getRandomCost(@rand, 3000);
			u16 randomChuckin = 1+getRandomCost(@rand, 10);
			...
			AddRequirement(s.requirements, "blob", "chicken", "Chicken", randomChuckin);
