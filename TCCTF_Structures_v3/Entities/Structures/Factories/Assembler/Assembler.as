...
void onInit(CBlob@ this)
{
	AssemblerItem[] items;
	{
		AssemblerItem i("mat_pistolammo", 800, "Low Caliber Bullets (800)");
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 20);
		AddRequirement(i.reqs, "blob", "mat_copperingot", "Copper Ingot", 16);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 100);
		items.push_back(i);
	}
	{
		AssemblerItem i("mat_rifleammo", 600, "High Caliber Bullets (600)");
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 20);
		AddRequirement(i.reqs, "blob", "mat_copperingot", "Copper Ingot", 12);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 100);
		items.push_back(i);
	}
	{
		AssemblerItem i("mat_gatlingammo", 2000, "Machine Gun Ammo (2000)");
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 40);
		AddRequirement(i.reqs, "blob", "mat_copperingot", "Copper Ingot", 30);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 200);
		items.push_back(i);
	}
	{
		AssemblerItem i("mat_shotgunammo", 400, "Shotgun Shells (400)");
		AddRequirement(i.reqs, "blob", "mat_copperingot", "Copper Ingot", 20);
		AddRequirement(i.reqs, "blob", "mat_wood", "Wood", 200);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 100);
		items.push_back(i);
	}
	{
		AssemblerItem i("mat_tankshell", 12, "Artillery Shells (12)");
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 3);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 60);
		items.push_back(i);
	}
	{
		AssemblerItem i("mat_howitzershell", 16, "Howitzer Shells (16)");
		AddRequirement(i.reqs, "blob", "mat_copperingot", "Copper Ingot", 8);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 120);
		items.push_back(i);
	}
	{
		AssemblerItem i("mat_smallbomb", 8, "Small Bombs (8)");
	...
	{
		AssemblerItem i("foodcan", 20, "Scrub's Chow (20)");
		AddRequirement(i.reqs, "blob", "mat_meat", "Mystery Meat", 100);
	...
	}
	{
		...
		AddRequirement(i.reqs, "blob", "mat_coal", "Coal", 6);
		items.push_back(i);
	}
	{
	...
	{
		AssemblerItem i("mat_dynamite", 4, "Dynamite (4)");
		AddRequirement(i.reqs, "blob", "mat_wood", "Wood", 50);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 80);
		items.push_back(i);
	}
	{
		AssemblerItem i("mat_fraggrenade", 4, "Fragmentation Grenade (4)");
		AddRequirement(i.reqs, "blob", "mat_ironingot", "Iron Ingot", 2);
		AddRequirement(i.reqs, "blob", "mat_sulphur", "Sulphur", 40);
		items.push_back(i);
	}
