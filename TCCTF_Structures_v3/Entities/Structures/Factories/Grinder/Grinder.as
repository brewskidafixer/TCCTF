...
void Blend(CBlob@ this, CBlob@ blob)
{
	...
	switch(hash)
	{
		case 1062293841://log
		{
			if (isServer())
			{
				MakeMat(this, this.getPosition(), "mat_wood", (100 + XORRandom(40)) * blob.getQuantity());
			}
		...
		case 575725963://mat_stone
		{
			if (isServer())
			{
				...
				MakeMat(this, this.getPosition(), "mat_iron", 		XORRandom(quantity * 0.10f));
				MakeMat(this, this.getPosition(), "mat_copper", 	XORRandom(quantity * 0.06f));
				MakeMat(this, this.getPosition(), "mat_gold",	 	XORRandom(quantity * 0.04f));
		...
		case 1074492747://mat_dirt
		{
			if (isServer())
			{
				...
				MakeMat(this, this.getPosition(), "mat_dirt", 		quantity * 0.75f + XORRandom(quantity * 0.20f));
		...
		case 1870714900://molecularfabricator
		case 881918781://scythergib
		{
			if (isServer())
			{
				MakeMat(this, this.getPosition(), "mat_plasteel", 5 + XORRandom(10));
				MakeMat(this, this.getPosition(), "mat_matter", 1 + XORRandom(3));
			}
			kill = true;
		}
		break;
		...
		case 336243301://steak
		{
			...
			if (isServer())
			{
				...
				MakeMat(this, this.getPosition(), "mat_meat", quantity * 30 + XORRandom(quantity * 10));
			}
...
bool isInventoryAccessible(CBlob@ this, CBlob@ forBlob)
{
	...
	return forBlob !is null && (forBlob.getName() == "extractor" || forBlob.getName() == "filterextractor" || this.getDistanceTo(forBlob) <= 64);
}
