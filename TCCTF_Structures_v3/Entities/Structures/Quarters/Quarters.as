...
void onInit(CBlob@ this)
{
	...
	// }
	{
		ShopItem@ s = addShopItem(this, "Burger", "$quarters_burger$", "food", "A burger to go.", true);
	...
	{
		ShopItem@ s = addShopItem(this, "Pumpkin Tea", "$ganjatea$", "tea", "A drink to ease the soul. Known to mysteriously stop illnesses.", false);
