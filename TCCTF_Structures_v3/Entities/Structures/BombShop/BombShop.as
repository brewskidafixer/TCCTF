...
void onInit(CBlob@ this)
{
	...
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_methane", "Methane", 10);
	...
	{
		ShopItem@ s = addShopItem(this, "Howitzer Shell (4)", "$icon_howitzershell$", "mat_howitzershell-4", "A large howitzer shell capable of annihilating a cottage.");
	...
	{
		ShopItem@ s = addShopItem(this, "Guided Rocket", "$icon_guidedrocket$", "guidedrocket", "A self-guided missile used to down bombers. Due to poorly designed navigation systems, it may display unpredictable behaviour.");
		AddRequirement(s.requirements, "coin", "", "Coins", 500);
	...
	{
		ShopItem@ s = addShopItem(this, "SAM Missile", "$mat_sammissile$", "mat_sammissile-1", "SAM Missile used by SAM.");
		AddRequirement(s.requirements, "coin", "", "Coins", 300);
