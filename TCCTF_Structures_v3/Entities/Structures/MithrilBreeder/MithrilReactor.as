...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params) //Mutate command
{
	if (cmd == this.getCommandID("upgrade"))
	{
		...
		if (caller !is null)
		{
			...
			{
				u16 cost = Maths::Max(this.get_s16("upgrade_cost")*4, 1);
				...
				else if (caller.isMyPlayer()) client_AddToChat("Not enough mithril ingots! Upgrade costs "+cost+" mithril ingots.", SColor(0xff444444));
			}
			...
			{	
				...
				{ 
					if (gold_blob !is null)
					{
						...
						Material::createFor(this, "mat_mithril", Maths::Ceil(amount * 3.00f));
