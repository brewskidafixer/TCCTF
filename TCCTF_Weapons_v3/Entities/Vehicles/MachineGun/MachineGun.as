...
void onInit(CBlob@ this)
{
	...
	settings.B_TTL = 10; //Bullet Time to live
	...
	if (gunner !is null && gunner.getOccupied() !is null)
	{
		...
		else
		{
			     ...
			     (facing_left && aim_vec.x > 0))
			{
				...
				angle = (-(aim_vec).getAngle() + 180.0f);
				angle = Maths::Max(-90.0f, Maths::Min(angle, 70.0f));
			}
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _unused)
{
	...
	this.set_u32("fireDelay", getGameTime() + 5);
}
...
{
	return forBlob !is null && (forBlob.getPosition() - this.getPosition()).Length() <= 24;
}
