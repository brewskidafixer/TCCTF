...
void onInit(CBlob@ this)
{
	...
	Vehicle_SetupWeapon(this, v,
	                    ...
	                    Vec2f(-6.0f, -5.5f), // fire position offset
    ...
    Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f(-20.0f, 7.5f));
    Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f(-13.0f, 7.5f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f(-6.0f, 7.5f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f(1.0f, 7.5f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f( 8.0f, 7.5f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f( 15.0f, 7.5f));
	Vehicle_addWheel(this, v, "CTankWheel.png", 9, 9, 0, Vec2f( 22.0f, 7.5f));
...
void Vehicle_onFire(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 _unused)
{
	if (bullet !is null)
	{
		...
		Vec2f vel = Vec2f(22.0f * (this.isFacingLeft() ? -1 : 1), 0.0f).RotateBy(angle);
		bullet.setVelocity(vel);

		Vec2f offset = Vec2f((this.isFacingLeft() ? -1 : 1) * 64, -2);
