...
void onInit(CBlob@ this)
{
	...
	this.getShape().SetGravityScale(0.59f);
...
void DoExplosion(CBlob@ this)
{
	...
	for (int i = 0; i < 4; i++) 
	{
		...
		LinearExplosion(this, dir, 24.0f + XORRandom(8) + (modifier * 4), 24 + XORRandom(16), 4, 0.50f, Hitters::explosion);
	}
