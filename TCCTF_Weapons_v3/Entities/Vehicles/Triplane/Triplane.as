...
void onInit(CBlob@ this)
{
	...
	this.set_f32("fuel_consumption_modifier", 0.4f);
}
		...
		if (pilot !is null && this.getHealth() > 5.00f)
		{
			...
			if (!this.hasTag("disable bomber drop") && ap_pilot.isKeyPressed(key_action3) && this.get_u32("lastDropTime") < getGameTime()) 
			{
				...
				if (inv !is null) 
				{
					...
					this.set_u32("lastDropTime",getGameTime() + 12);
				}
			}
		}
	}
...
void onCollision(CBlob@ this,CBlob@ blob,bool solid)
{
	...
	if (power > 6.0f && blob == null)
	{
		...
		this.server_Hit(this, this.getPosition(), Vec2f(0, 0), (this.getAttachments().getAttachmentPointByName("FLYER") is null || this.getHealth() < 4.0f) ? power * 1.5f : power * 0.0020f, 0, true);
	}
}
