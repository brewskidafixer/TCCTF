...
void onInit(CBlob@ this)
{
	...
	else if (configName == "steamtankwreck") mats.push_back(HarvestBlobMat(10.0f, "mat_ironingot"));
	else if (configName == "triplanewreck") mats.push_back(HarvestBlobMat(100.0f, "mat_wood"));
	else if (configName == "chickentankwreck") { mats.push_back(HarvestBlobMat(40.0f, "mat_ironingot")); mats.push_back(HarvestBlobMat(30.0f, "mat_steelingot")); mats.push_back(HarvestBlobMat(10.0f, "mat_copperwire"));}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("shop made item"))
	{
		...
		if (isServer())
		{
			...
			blob.server_SetHealth(blob.getInitialHealth() * this.getHealth()/this.getInitialHealth());
			this.server_Die();
		}
	}
}
